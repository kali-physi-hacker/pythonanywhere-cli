...
class Command(object):
    ...
    def run(self):
        for command in self.COMMANDS:
            if self.options.has_key(command) and self.options[command]:
...
class StaticFile(Command):
    ...
    def create(self):
        ...
        response = self.client.webapps.static_files.create(
    ...
    def delete(self):
        ...
        response = self.client.webapps.static_files.delete(
    ...
    def update(self):
        ...
        response = self.client.webapps.static_files.update(
...
class Webapps(Command):
    ...
    def create(self):
        ...
        response = self.client.webapps.create(data={
                "domain_name": domain_name,
                "python_version": python_version,
        })

        return ("Webapp created with domain {}"
            " using python version {}.").format(domain_name, python_version)

    def delete(self):
        domain_name = self.options["<domain_name>"]

        response = self.client.webapps.delete(domain_name=domain_name)
    ...
    def reload(self):
        ...
        response = self.client.webapps.reload(domain_name=domain_name)
    ...
    def update(self):
        ...
        response = self.client.webapps.update(
